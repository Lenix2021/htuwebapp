...
$sql = "SELECT schemepath FROM approvescheme WHERE id = '$qid'";
...
$query = "SELECT * FROM approvescheme WHERE id = $qid";
...
if (isset($_POST['Accepts'])) {
	// update database
	$sql_update = "UPDATE print SET schemepath = '$schemepath' WHERE C_CODE = '$code'";

	if(mysqli_query($conn, $sql_update))
{   $query = "DELETE FROM dissaprovescheme where C_CODE = '$code'";
    $result = mysqli_query($conn, $query);

    $query = "DELETE FROM approvescheme where C_CODE = '$code'";
    $result = mysqli_query($conn, $query);
...
if (isset($_POST['rejects'])) {
    ...
    $sql_update = "UPDATE dissaprovescheme SET comment = '$comment' , progress = 'pending' WHERE C_CODE = '$code'";
    ...
    <div class="form-container">
      ...
      <form method="POST">
        ...
        <br>
          ...
          <input type="submit" value="Approve" name="Accepts">
          </div>
  </br>

          <div class="ript" style="margin-left: 159px;">
            <textarea id="general-observation" name="reject_comment" placeholder="Reason for Rejection"></textarea>
            </div>


          <div class="form-actions">
          <input type="submit" value="Dissaprove" name="rejects">
          </div>
        </div>
      </form>
    </div>
