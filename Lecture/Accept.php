...
<head>
    ...
    <link rel="stylesheet" href="../css/addmin.css?0023456709">
    ...
    <div class="view">
        <div class="tb">
            <table cellpadding="5">
                ...
                <?php
                $sno = 1;
                $sql = "SELECT a.*,c.C_TITLE
                FROM approve a
                JOIN courses c ON a.C_CODE = c.C_CODE
                 WHERE Modid = '$key'";
                ...
                <tr>
                    ...
                    <td>
                        ...
                        $link = "AcceptQuestion.php?p=$encoded_id";
                        echo "<div class='edita'><a href='$link'>View Updated Question</a></div>";
                        ?>
                    </td>
                </tr>
                <?php
            ...
            <table cellpadding="5">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        // Base64 encode the ID value
                        $encoded_id = base64_encode($id);
                        $link = "AcceptScheme.php?p=$encoded_id";
                        echo "<div class='edits'><a href='$link'>View Updated Marking scheme</a></div>";
                        ?>
                    </td>
                </tr>
                <?php
